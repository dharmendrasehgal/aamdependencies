...
(function(h) {
    ...
    r(q.prototype, {
        ...
        init: function(b, a) {
            var c = b.options.legend.layout !== "vertical",
                d;
        ...
        drawLegendSymbol: function(b, a) {
            var c = b.padding,
                ...
                j = o(d.labelPadding, e ? 16 : 30),
                d = o(d.itemDistance, 10);
            this.setLegendColor();
            a.legendSymbol = this.chart.renderer.rect(0, b.baseline - 11, f, g).attr({
                zIndex: 1
            }).add(a.legendGroup);
        ...
        drawCrosshair: function(b,
            ...
            var c = !this.cross,
                ...
                f, g = this.pos,
                j = this.len;
            if (a) f = this.toPixels(a.value), f < g ? f = g - 2 : f > g + j && (f = g + j + 2), a.plotX = f, a.plotY = this.len - f, k.prototype.drawCrosshair.call(this, b, a), a.plotX = d, a.plotY = e, !c && this.cross && this.cross.attr({
    ...
    i(["fill", "stroke"], function(b) {
		if(!HighchartsAdapter.addAnimSetter)
			return;
    ...
    p.heatmap = A(p.scatter, m(h, {
        ...
        translate: function() {
            ...
            i(this.points, function(d) {
                var e = (b.colsize || 1) / 2,
                    f = (b.rowsize || 1) / 2,
                    g = Math.round(a.len - a.translate(d.x - e, 0, 1, 0, 1)),
                    e = Math.round(a.len - a.translate(d.x + e, 0, 1, 0, 1)),
